...
class MyGUI(QMainWindow):
    def __init__(self):
        ...
        try: uic.loadUi("main.ui", self); system("cls")
            ...
            print("Please visit https://github.com/OZX-OG/ To download file 'main.ui'")
            sleep(10)
            exit()
    ...
    def default(self):
        ...
        try: f = open("words.txt", "r", encoding='UTF-8')
            ...
            print("File Not Found")
            print("Please visit https://github.com/OZX-OG/Speed-Typing-Test To download file 'words.txt'")
